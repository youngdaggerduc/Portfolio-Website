...
> **Free-tier caveat.** Render's free web service sleeps after 15 min idle. The first request after sleep takes ~30 s while it cold-starts. The chatbot and games will show a "thinking" state during this. If that bothers you, upgrade to the $7/mo Starter plan (no sleep) or use [UptimeRobot](https://uptimerobot.com) to ping `/healthz` every 5 min for free.
